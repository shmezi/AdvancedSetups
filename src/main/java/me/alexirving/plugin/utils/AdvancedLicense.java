...
public class AdvancedLicense {
  ...
  private String securityKey = "WTr9gLBuAsCUvQwUzhEuhta32DZgMnpFw4XH";
  ...
  private void log(int type, String message) {
    ...
    AdvancedSetups.getInstance().getLogger().info(message);
  }
}
